...
function Nav() {
  ...
  <svg className='open' fill="#aff00" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px">
  ...
  return <>
    <nav className="navbar navbar-expand-lg navbar-light navbar-right">
      <div className="container">
        ...
        <div className={`${isNavCollapsed ? 'collapse' : 'collapsed'} navbar-collapse`} id="navbarsExample09">
          <ul className="navbar-nav ml-auto mb-2 mb-lg-0 ">
            <li className="nav-item">
              <a className="nav-link active" aria-current="page" href="#home">Home</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#SeaechRegion">Our Results</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#Symptoms">Exterior</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#protect">Interior</a>
            </li>
            <li className="nav-item">
